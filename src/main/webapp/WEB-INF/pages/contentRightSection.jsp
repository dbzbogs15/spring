	...
	<aside class="right_content">
					...
					<li>
						<div class="media wow fadeInDown">
							<a href="pages/single_page.html" class="media-left"> <img
								alt=""
								src="${pageContext.request.contextPath}/resources/${topView.image}">
							</a>
		...
		<div class="single_sidebar">
			...
			<div class="tab-content">
				<div role="tabpanel" class="tab-pane active" id="category">
					<ul>
						<li class="cat-item"><a href="#">Anime</a></li>
						<li class="cat-item"><a href="#">Manga</a></li>
						<li class="cat-item"><a href="#">Light Novel</a></li>
						<li class="cat-item"><a href="#">Cosplay</a></li>
					...
					<ul class="spost_nav">
						<li>
							<div class="media wow fadeInDown">
								<a href="pages/single_page.html" class="media-left"> <img
									alt=""
									src="${pageContext.request.contextPath}/resources/images/post_img1.jpg">
								</a>
								<div class="media-body">
									<a href="pages/single_page.html" class="catg_title">
						...
						<li>
							<div class="media wow fadeInDown">
								<a href="pages/single_page.html" class="media-left"> <img
									alt=""
									src="${pageContext.request.contextPath}/resources/images/post_img2.jpg">
								</a>
								<div class="media-body">
									<a href="pages/single_page.html" class="catg_title">
		...
		<div class="single_sidebar wow fadeInDown">
			...
			<a class="sideAdd" href="#"><img
				src="${pageContext.request.contextPath}/resources/images/add_img.jpg"
				alt=""></a>
		</div>
		<div class="single_sidebar wow fadeInDown">
			<h2>
